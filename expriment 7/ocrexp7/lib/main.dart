  ...
  class _MainScreenState extends State<MainScreen> with WidgetsBindingObserver {
    ...
    Future<void> initTTS() async {
      ...
      await flutterTts.setSpeechRate(
          0.5); // Adjust speech rate (1.0 is normal but too fast for my liking)
            ...
            children: [
              ...
              Scaffold(
                appBar: AppBar(
                  ...
                  title: const Text('OCR Road Signal Recognition'),
                  centerTitle: true,
                ),
                              ...
                              child: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  minimumSize: WidgetStateProperty.all<Size>(
                                    const Size(256,
                                        64), // Set the desired width and height
                                  ),
                                ),
                                child: const Text('Scan Traffic sign'),
                              ),
                            ),
                          ),
                        ],
